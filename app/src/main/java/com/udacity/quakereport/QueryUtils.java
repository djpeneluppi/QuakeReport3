        ...
        try {
            ...
            for(int i=0; i<features.length(); i++) {
                ...
                if(place.contains(" of ")) {
                    ...
                    placeRegion = placeParts[0] + " of";
                    placeLocation = placeParts[1];
                    Log.v(TAG, placeRegion);
                    Log.v(TAG, placeLocation);
                } else {
                    placeRegion = place;
                    placeLocation = "";
                }
                ...
                dateObject = new Date(timeInMiliseconds);
                ...
                Log.v(TAG, quakeURL);
                //
                //earthquakes.add(new EarthQuake(magnitude, placeRegion, placeLocation, dateToDisplay, timeToDisplay));
                earthquakes.add(new EarthQuake(magnitude, placeRegion, placeLocation,
                        dateToDisplay, timeToDisplay, quakeURL));
